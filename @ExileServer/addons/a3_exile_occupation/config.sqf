...
SC_maxAIcount					= 105;						// the maximum amount of AI, if the AI count is above this then additional AI won't spawn
...
SC_minDistanceToPlayer      	= 500;                  	// Minimum distance in metres to the nearest player
...
SC_minimumCrewAmount        	= 4;     	// Minimum amount of AI allowed in a vehicle
