...
_servicePointClasses = ["Land_FuelStation_Feed_F","Land_FuelStation_Shed_F","Land_fs_feed_F"]; // service point classes (can be house, vehicle and unit classes)
...
_actionColour = "#eef704"; //the colour of the scroll action yellow: "#eef704"
