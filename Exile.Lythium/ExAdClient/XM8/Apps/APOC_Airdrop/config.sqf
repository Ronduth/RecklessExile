...
//Also, presently, these are NON-Persistant vehicles.  Meaning that they will not last over a restart.  Keep that in mind with prices.  Later updates I'll set that up, with pin code entry.
	["Vehicles",
		[
			["Quadbike", 		"Exile_Bike_QuadBike_Black", 		200, 	"vehicle", 0],
			["Offroad", 		"Exile_Car_Offroad_Red",			20000, 	"vehicle", 0],
			["Strider", 		"Exile_Car_Strider", 				30000, 	"vehicle", 10000]
		]
	],

	["Weapons",
		[
			["Sniper Rifles", 		"airdrop_Snipers", 			50000, "supply", 15000],
			["DLC Rifles", 			"airdrop_DLC_Rifles", 			45000, "supply", 5000],
			["DLC LMGs", 			"airdrop_DLC_LMGs", 			45000, "supply", 10000]
		]
	],
	...
	["Supplies",
		[
			...
			["Food (large)",		"airdrop_FoodLarge",			5000, "supply", 5000]
		]
	]
];
