...
[
	"Connect to the RGN discord at Discord.gg/RGN",
	"Welcome, things are about to get a whole lot more reckless...",
	...
	"Press '6' key for tablet in game to view Server Rules and extras",
	"Do not leave vehicles on exile base parts, at restart they will likely explode",
	"New to the server? Come introduce yourself! www.recklessnetwork.com"
];
