...
/* Mission System Settings */
	...
	DMS_CompletedMissionCleanupTime		= 1500;						// Minimum time until mission-spawned buildings and AI are cleaned up
...
/* AI Settings */
	...
	DMS_Bandit_Soldier_RepGain			= 40;						// The amount of Respect gained for killing a bandit soldier
	...
	DMS_Bandit_Vehicle_RepGain			= 40;						// The amount of Respect gained for killing a bandit vehicle crew member
...
/* DonkeyPunchDMS Custom Settings for Hero AI*/
	...
	DMS_Hero_Static_RepGain				= 40;						// The amount of Respect gained for killing a hero static gunner
