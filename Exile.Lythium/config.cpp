...
class CfgXM8
{
	extraApps[] = {"ExAd_VG","ExAd_Info","ExAd_CHVD","ExAd_Journal","ExAd_Bike","ExAd_Quad","ExAd_SB","ExAd_APOC_Airdrop"};
...
class CfgInteractionMenus
{
	class Car
    {
        ...
        class Actions
        {
            ...
            // Retrieve body from destroyed vehicle
            class Salvage: ExileAbstractAction
            {
                title = "Retrieve Body";
                condition = "(!(alive (ExileClientInteractionObject)))";
                action = "_this call NR_fnc_RetrieveBody";
            };
