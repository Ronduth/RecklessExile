...
_colorTitle         = "#c1bfbe"; // HTML Color Code of the Title Messages (must start with '#' )
_colorSubText         = "#FF7900"; // HTML Color Code of the SubTitle Messages (must start with '#' )
...
_FadeIn             = 7; //how long one role should stay on screen. Use value from 0 to 10 where 0 is almost instant transition to next role
...
_title2         = "Rules:";
_shorttext2     = "Make sure to read the server Info and FAQs in the XM8 under the more tab";
...
_title5         = "Just games, no bullshit";
_shorttext5     = "Stay Reckless";
